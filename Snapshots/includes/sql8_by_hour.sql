--  start h:\sql\u\sql8_by_hour.txt
...
/*--------------------------------------------------------*/
start  includes/sql8_by_hour_all_sqls.sql
...
select 'start includes/sql8_by_hour_one_sql.sql '||to_char(hash_value)
...
/*--------------------------------------------------------*/
spool H:/sql/reports/sql_by_hour_&&upperdb..lst
