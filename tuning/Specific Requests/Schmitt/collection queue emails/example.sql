    ...
    SELECT cust.ky_enroll
     ...
     WHERE a.ky_supplier = 'XOOM'
       ...
       AND a.cd_queue_status <> 'DN'
	     and a.ky_utility_name in ('PGE',        'SOCAL',
					                       'SDGE',       'CPL',
					                       'WTU',        'CPE',
					                       'ONCOR',	     'TNMP',
					                       'NICOR',	     'COMED',
...
BEGIN
    ...
    -- Had to do it this way because the CASE statement in the cursor
    ...
    dbms_output.put_line ('Step #2: '||to_char(l_step_2 - l_step_1));
    dbms_output.put_line ('Step #3: '||to_char(l_step_3 - l_step_2));
