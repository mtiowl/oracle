...
SELECT DISTINCT MSTR_PH.KY_BA, MSTR_PH.DT_BILLED_BY_CSS, MSTR_PH.KY_SUPPLIER
  FROM CPM_SUMMBILL_PND_LNK PND_LNK
      ,CPM_PND_TRAN_HDR MBR_PH
      ,CPM_PND_TRAN_HDR MSTR_PH
      ,CPM_CD_PURPOSE PURP
  WHERE MBR_PH.KY_SUPPLIER = 'TESI' 
    AND MBR_PH.KY_ENROLL = 1234 
