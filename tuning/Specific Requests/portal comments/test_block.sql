DECLARE
   l_clob CLOB;
BEGIN
l_clob := DBMS_XMLGEN.getXml('SELECT  CIS_CL_HEADER.KY_CALL_LOG_ID,
...
--      AND   CIS_CL_HEADER.KY_ENROLL = 1566339
      AND   CIS_CL_HEADER.KY_ENROLL = 1
    ORDER BY CIS_CL_HEADER.TS_ADDED DESC',0);

    DELETE mti_test;
    INSERT INTO mti_test VALUES (l_clob);
END;
/
