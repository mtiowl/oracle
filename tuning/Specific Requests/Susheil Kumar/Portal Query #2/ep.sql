...
FROM 
	PVIEW.ACCOUNT 
	JOIN PVIEW.BILL_ACCOUNT bill_account ON (bill_account.ky_enroll = account.ky_enroll AND bill_account.ky_supplier = account.ky_supplier) 
	JOIN PVIEW.ENROLL ENROLL ON (enroll.ky_enroll = account.ky_enroll AND enroll.ky_supplier = account.ky_supplier)
WHERE 
