...
select bytes/1024          "EXT_KB",
  ...
  from (select bytes, count(*) N from dba_extents
...
select b.index_name,b.column_name,c.num_distinct,
  ...
  from dba_ind_columns b, dba_tab_columns c
...
/*-----------------------------------------------------------------*/
/*              Column Expressions                                 */
/*         (e.g. function based indexes)                           */
/*-----------------------------------------------------------------*/

set linesize 300

select table_owner, index_name, column_expression
